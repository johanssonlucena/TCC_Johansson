...
const icons = {
    'Porte Ilegal de Arma de Fogo e/ou munição': L.icon({ iconUrl: 'https://maps.google.com/mapfiles/ms/icons/blue-dot.png', iconSize:[25,25]}),
    'Posse Ilegal de Arma de Fogo e/ou munição': L.icon({ iconUrl: 'https://maps.google.com/mapfiles/ms/icons/orange-dot.png', iconSize:[25,25]})
};
